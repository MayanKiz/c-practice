...
A practice repository for small C programming exercises, experiments, and learning notes.

## Quick Start

Compile an exercise with a C compiler such as GCC, for example `gcc file.c -o file`, then run the generated executable.
